                        ...
                        <form method="post">
                            <div class="col-md-12">
                                ...
                                <div class="forms-inputs mt-3">
                                    ...
                                    <input type="text" id="update-collection-name" class="form-control" autocomplete="off">
                                ...
                                <div class="forms-inputs mt-3">
                                    ...
                                    <input type="date" id="update-release-date" class="form-control" autocomplete="off">
